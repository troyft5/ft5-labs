  ...
  return (
    <div className="flex flex-col w-full bg-white min-h-screen">
      <section className="px-6 py-24 max-w-4xl mx-auto text-center w-full">
        <div className="inline-flex items-center gap-2 mb-6 px-4 py-2 bg-brand-50 text-brand-700 border border-brand-100 rounded-full text-sm font-bold uppercase tracking-wide">
          Payment Solutions
        </div>
        ...
        <Link href="/get-your-savings-estimate" className="inline-flex px-8 py-4 text-base font-bold bg-brand-600 hover:bg-brand-700 text-white rounded-lg shadow-lg transition-all items-center justify-center gap-2">
