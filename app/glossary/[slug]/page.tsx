        ...
        <div className="relative max-w-3xl mx-auto text-center">
          <Reveal>
            ...
            <p style={{ color: 'rgba(255,255,255,0.75)' }} className="text-lg mb-10 max-w-xl mx-auto">
              Upload your statement. We will show you every fee by name, what each one costs you a year, and what you would pay with a better processor. Most take about 15 minutes. Free.
            </p>
