...
const resources = [
  ...
  },
  {
    ...
    color: '#f59e0b',
    desc: 'Upload a statement. We send a line-by-line analysis and bids from 10+ processors. Most take about 15 minutes. A day is the longest it takes. No cost.',
  ...
  },
  {
    ...
    href: '/contact-us',
    color: '#06b6d4',
    desc: 'A real person picks up. No ticket queue. No bot. If you send a statement, we can often have numbers in about 15 minutes.',
    cta: 'Get in Touch',
    stat: '< 1 Day Response',
  },
]
          ...
          <Reveal delay={280}>
            <div className="flex flex-wrap gap-3">
              {[
                ...
                { label: '15 min typical audit', color: '#6fc200' },
              ].map(item => (
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  { icon: <FileText className="w-5 h-5" />, stat: '15m', label: 'Audit turnaround', note: 'typical. 1 day max' },
      ...
      <section className="px-6 py-16 relative overflow-hidden" style={{ background: '#4e9000' }}>
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <p style={{ color: 'rgba(255,255,255,0.75)' }} className="text-lg mb-8 max-w-xl mx-auto">
            Upload a statement or just your contact info. We send a full savings analysis with competitive bids. Most take about 15 minutes.
          </p>
