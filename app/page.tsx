  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <section className="relative px-6 py-24 md:py-32 max-w-7xl mx-auto flex flex-col items-center text-center">
        <div className="inline-flex items-center gap-2 mb-6 px-4 py-2 bg-blue-50 text-blue-700 rounded-full text-sm font-semibold border border-blue-100">
        ...
        <h1 className="text-5xl md:text-7xl font-black tracking-tight mb-6 text-slate-900 max-w-4xl leading-[1.1]">
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500">Payment Processors.</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
          <Link href="#contact" className="px-8 py-4 text-base font-bold bg-blue-600 hover:bg-blue-700 text-white rounded-lg shadow-lg hover:shadow-blue-600/20 transition-all flex items-center justify-center gap-2">
            Schedule Free Savings Audit <ArrowRight className="w-5 h-5" />
          </Link>
          <Link href="#solutions" className="px-8 py-4 text-base font-bold bg-white border border-slate-200 hover:border-blue-200 hover:bg-blue-50 text-slate-700 rounded-lg transition-all flex items-center justify-center gap-2">
            Explore Solutions
          </Link>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
              <div className="w-12 h-12 bg-blue-100 text-blue-600 rounded-xl flex items-center justify-center mb-6 font-black text-xl">1</div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
              <div className="w-12 h-12 bg-blue-100 text-blue-600 rounded-xl flex items-center justify-center mb-6 font-black text-xl">2</div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
              <div className="w-12 h-12 bg-blue-100 text-blue-600 rounded-xl flex items-center justify-center mb-6 font-black text-xl">3</div>
