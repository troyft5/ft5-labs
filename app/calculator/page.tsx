        ...
        <div className="relative max-w-4xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p style={{ color: 'rgba(255,255,255,0.75)' }} className="text-lg leading-relaxed">The calculator gives you direction. The statement audit gives you proof — with line-by-line fee breakdown and competitive bids from 14 processors.</p>
            </div>
            <div className="flex flex-col gap-4">
