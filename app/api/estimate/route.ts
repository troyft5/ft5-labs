      ...
      const results = await Promise.all([
        ...
        resend.emails.send({
          ...
          html: confirmationEmail({
            ...
            body: `We have your statement. Most audits come back in about <strong style="color:#ffffff">15 minutes</strong>. A day is the longest it takes. You will get a full breakdown of what you pay now and what a better rate looks like.`,
