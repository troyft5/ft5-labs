...
import { ArrowRight, Shield, TrendingUp, Phone, Zap, CheckCircle2 } from 'lucide-react'
        ...
        <div className="relative max-w-5xl mx-auto">
          <Reveal>
            <div className="flex items-center gap-3 mb-8">
              ...
              <span className="text-[11px] font-bold uppercase tracking-[0.2em]" style={{ color: '#6fc200' }} dangerouslySetInnerHTML={{ __html: 'Founded 2021 · New York &amp; New Jersey' }} />
            </div>
          </Reveal>
