...
const GREEN = '#4e9000'
const GREEN_BRIGHT = '#6fc200'
const BG = '#0a1208'

const WORDMARK = `<span style="font-size:22px;font-weight:900;font-style:italic;color:#ffffff;letter-spacing:-0.5px">Fin<span style="color:${GREEN_BRIGHT}">Tech</span> 5</span>`
  ...
  const stepsHtml = steps.map((s, i) => `
    <tr>
      <td width="28" valign="top" style="padding:0 10px 14px 0">
        <table cellpadding="0" cellspacing="0" width="22" height="22" style="background:rgba(111,194,0,0.15);border:1px solid rgba(111,194,0,0.4);border-radius:50%">
          <tr><td align="center" style="font-size:11px;font-weight:900;color:${GREEN_BRIGHT}">${i + 1}</td></tr>
        </table>
      </td>
      <td style="padding:0 0 14px;font-size:13px;color:#c4d0c4;line-height:1.5">${esc(s)}</td>
    </tr>
  `).join('')

  return `
<div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;max-width:560px;margin:0 auto;background:${BG};color:#ffffff;border-radius:16px;overflow:hidden;border:1px solid rgba(255,255,255,0.06)">
  <table width="100%" cellpadding="0" cellspacing="0"><tr><td height="5" style="background:linear-gradient(90deg,#2d5500,${GREEN_BRIGHT});font-size:0;line-height:0">&nbsp;</td></tr></table>
  <div style="padding:44px 40px 36px">
    <div style="margin-bottom:28px">${WORDMARK}</div>
    <div style="display:inline-block;background:rgba(111,194,0,0.12);border:1px solid rgba(111,194,0,0.3);border-radius:20px;padding:5px 14px;margin-bottom:20px">
      <span style="font-size:10px;font-weight:800;color:${GREEN_BRIGHT};text-transform:uppercase;letter-spacing:0.14em">✓ Received</span>
    </div>
    <h1 style="font-size:26px;font-weight:900;margin:0 0 14px;color:#ffffff;line-height:1.25">${esc(heading)}</h1>
    <p style="color:#94a3b8;line-height:1.65;margin:0 0 28px;font-size:14.5px">${body}</p>

    <table width="100%" cellpadding="0" cellspacing="0" style="background:rgba(78,144,0,0.08);border:1px solid rgba(78,144,0,0.22);border-radius:12px;margin-bottom:26px">
    ...
    <table cellpadding="0" cellspacing="0"><tr>
      <td style="padding-right:10px">
        <a href="https://fintech5group.com" style="display:inline-block;background:${GREEN};color:#ffffff;font-weight:800;font-size:13.5px;padding:13px 26px;border-radius:10px;text-decoration:none">Visit FinTech 5</a>
      </td>
      <td>
        <a href="tel:6469417853" style="display:inline-block;background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.14);color:#e2e8f0;font-weight:700;font-size:13.5px;padding:13px 22px;border-radius:10px;text-decoration:none">Call (646) 941-7853</a>
      </td>
    </tr></table>
  </div>
  <table width="100%" cellpadding="0" cellspacing="0" style="border-top:1px solid rgba(255,255,255,0.06)">
    <tr><td style="padding:20px 40px">
      <p style="margin:0;font-size:10.5px;color:#4b5563;letter-spacing:0.02em">
        No consulting fees ever &nbsp;·&nbsp; No obligation to switch &nbsp;·&nbsp; Response within 1 business day
      </p>
      <p style="margin:8px 0 0;font-size:10.5px;color:#374151">
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:${BG}">
    <tr><td style="padding:20px 30px">
      <table width="100%" cellpadding="0" cellspacing="0"><tr>
        <td>${WORDMARK}</td>
        <td align="right" style="font-size:10px;font-weight:800;color:${GREEN_BRIGHT};text-transform:uppercase;letter-spacing:0.14em">New Activity</td>
      </tr></table>
    </td></tr>
  </table>
