...
export const glossaryData: GlossaryTerm[] = [
  // ── PRICING ──────────────────────────────────────────────────────────────
  {
    ...
    category: 'pricing',
    shortDef: 'A transparent pricing model that passes interchange at cost and adds a fixed processor markup, typically the lowest-cost structure for most merchants.',
    body: [
  ...
  },
  {
    ...
    slug: 'effective-rate',
    category: 'pricing',
    shortDef: 'Your total processing cost divided by your gross card volume. It is the only honest apples-to-apples comparison across pricing models.',
    body: [
  ...
  },
  {
    ...
    category: 'pricing',
    shortDef: 'The processor\'s margin added on top of interchange and the only part of your processing cost that is negotiable.',
    body: [
  ...
  // ── FEES ─────────────────────────────────────────────────────────────────
  {
    ...
    slug: 'interchange',
    category: 'fees',
    shortDef: 'The per-transaction fee set by Visa and Mastercard, paid to the card-issuing bank. It is the largest and non-negotiable component of processing costs.',
    body: [
      'Interchange is paid by your acquiring bank to the bank that issued the card your customer used. Visa and Mastercard publish interchange tables annually with hundreds of rate categories depending on card type, transaction type, and merchant category code (MCC).',
  ...
  },
  {
    ...
    slug: 'junk-fees',
    category: 'fees',
    shortDef: 'Low-dollar recurring fees added to merchant statements that are not required by card networks. They are pure processor margin with no corresponding service.',
    body: [
  ...
  },
  {
    ...
    slug: 'basis-point',
    category: 'fees',
    shortDef: 'One one-hundredth of a percent (0.01%), used as the standard unit for expressing processor markups and interchange rates.',
    body: [
  ...
  },
  {
    ...
    category: 'fees',
    shortDef: 'A pre-chargeback request from a cardholder\'s bank for transaction documentation. It carries a fee regardless of outcome.',
    body: [
  ...
  // ── FRAUD & SECURITY ──────────────────────────────────────────────────────
  {
    ...
    slug: 'avs',
    category: 'fraud',
    shortDef: 'A fraud prevention service that checks a cardholder\'s billing address against the card issuer\'s records, reducing downgrade risk on keyed and card-not-present transactions.',
    body: [
  ...
  },
  {
    ...
    slug: 'cvv',
    category: 'fraud',
    shortDef: 'Security codes on a card used to verify the cardholder has the physical card. CVV is the magnetic stripe code; CVV2 is the printed 3-digit code required for card-not-present.',
    body: [
  ...
  // ── COMPLIANCE ────────────────────────────────────────────────────────────
  {
    ...
    merchantImpact: 'Many processors charge a monthly "PCI non-compliance fee" while making the actual compliance process difficult to find. Complete your SAQ and the fee goes away. Use it as a negotiation point to have it waived entirely.',
  ...
  },
  {
    ...
    slug: 'ach',
    category: 'processing',
    shortDef: 'The electronic network used to transfer funds between bank accounts; it is how your processing deposits land in your checking account.',
    body: [
  ...
  },
  {
    ...
    body: [
      ...
      'Level III data includes everything in Level II plus detailed line-item data: product descriptions, quantities, unit prices, commodity codes, and more. Level III qualifies for the lowest available interchange on purchasing cards, with savings that can reach 0.8–1.0% compared to standard business card rates.',
      'For B2B merchants that regularly accept corporate purchasing cards, government cards, or fleet cards, implementing Level II/III can reduce interchange costs by thousands of dollars per month at meaningful volume. The setup requires a gateway or POS system that supports the additional data fields, and not all do by default.',
    ],
