    ...
    <nav className="fixed top-0 w-full z-50 bg-white/97 backdrop-blur-md border-b border-slate-200 shadow-sm">
      ...
      {mobileOpen && (
        <div className="md:hidden bg-white border-t border-slate-100 px-6 py-4 flex flex-col gap-1 shadow-lg max-h-[80vh] overflow-y-auto">
          ...
          <Link href="/calculator" className="py-3 text-sm font-bold text-slate-700 border-b border-slate-100" onClick={() => setMobileOpen(false)}>Calculator</Link>
          <Link href="/blog" className="py-3 text-sm font-bold text-slate-700 border-b border-slate-100" onClick={() => setMobileOpen(false)}>Blog</Link>
          <Link href="/contact-us" className="py-3 text-sm font-bold text-slate-700 border-b border-slate-100" onClick={() => setMobileOpen(false)}>Contact</Link>
